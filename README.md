# apigw-websockets-lambda-dynamodb-sam-java
...
```bash
apigw-websockets-lambda-dynamodb-sam-java$ sam build
apigw-websockets-lambda-dynamodb-sam-java$ sam deploy --guided
```
...
```bash
apigw-websockets-lambda-dynamodb-sam-java$ sam local invoke HelloWorldFunction --event events/event.json
```

The SAM CLI can also emulate your application's API. Use the `sam local start-api` to run the API locally on port 3000.

```bash
apigw-websockets-lambda-dynamodb-sam-java$ sam local start-api
apigw-websockets-lambda-dynamodb-sam-java$ curl http://localhost:3000/
```
...
```bash
apigw-websockets-lambda-dynamodb-sam-java$ sam logs -n HelloWorldFunction --stack-name <Name-of-your-deployed-stack> --tail
```
...
```bash
apigw-websockets-lambda-dynamodb-sam-java$ cd HelloWorldFunction
